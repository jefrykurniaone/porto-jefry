...
- [ ] **UI-05**: All `sgds:text-muted` text meets WCAG AA contrast (≥4.5:1) in both light and dark themes — fixed via a single `--sgds-color-muted` override in `globals.css` (root cause: token was `#c6c6c6` day / `#3b3b3b` night ≈ 1.6:1)
