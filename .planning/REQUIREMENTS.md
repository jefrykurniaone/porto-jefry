...
- [ ] **NAV-01**: On phones (below the `md` 768px breakpoint), the navbar shows only the brand and a hamburger button; the inline desktop nav links are hidden so they no longer overflow or get clipped
...
- [ ] **A11Y-04**: The hamburger, drawer controls, and any horizontal-scroll affordance have accessible labels and ≥44px touch targets
