# Requirements Archive: v1.4 Polish & International Content
...
- [x] **CONTENT-01**: Core prose (hero subtitle/title, about summary, experience bullets, contact, certification) rewritten in a natural, non-buzzword voice via the free `blader/humanizer` skill; includes a remote/international + relocation availability signal; EN/ID key parity preserved
- [x] **CONTENT-02**: All 14 projects have bilingual descriptions sourced from i18n (`projects.items.<id>.description`); `Projects.tsx` reads them via next-intl with a missing-key guard
- [x] **CONTENT-03**: Education majors/degrees use idiomatic English ("Diploma in Informatics Management", "Bachelor's in Information Systems")
...
| UI-05 | Phase 6 — Look & Feel Polish | ✅ Complete |
| UI-06 | Phase 6 — Look & Feel Polish | ✅ Complete |
| UI-07 | Phase 6 — Look & Feel Polish | ✅ Complete |
| IA-01 | Phase 7 — Information Architecture | ✅ Complete |
| CONTENT-01 | Phase 8 — International Content | ✅ Complete |
| CONTENT-02 | Phase 8 — International Content | ✅ Complete |
| CONTENT-03 | Phase 8 — International Content | ✅ Complete |

**Coverage:**

- v1.3 requirements: 16 total — ✅ all complete (FIX-01..04, UX-01..04, SEC-01..03, TYPE-01..02, QUAL-01..03) — archived
- v1.4 requirements: 7 total (UI-05..07, IA-01, CONTENT-01..03) — ✅ all complete (shipped via PRs #31 + #32)
- v1.4 roadmap written: 2026-06-20; shipped: 2026-06-21

---
*Requirements defined: 2026-06-02*
*Last updated: 2026-06-21 — milestone v1.4 (polish-and-international-content) complete; all 7 requirements shipped*
