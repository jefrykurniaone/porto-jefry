...
function HeroCtas({
    ...
    isDownloading, onDownload, onScrollTo,
...
function HeroHeading({ statusPill, photoAlt, greeting, name, subtitle, typed }: Readonly<{
    statusPill: string;
    photoAlt: string;
    greeting: string;
    name: string;
    ...
    return (
        <>
            ...
            <div className='hero__photo'>
                <Image src='/cv-photo.webp' alt={photoAlt} width={116} height={116} priority />
            </div>
