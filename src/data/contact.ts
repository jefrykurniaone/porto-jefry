...
export const CONTACT_LINKEDIN_HANDLE = 'jefrykurniaone';
export const CONTACT_GITHUB_URL = 'https://github.com/jefrykurniaone/';
export const CONTACT_GITHUB_DISPLAY = 'github.com/jefrykurniaone';
